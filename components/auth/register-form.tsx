    ...
    <form onSubmit={handleRegister} className="space-y-4">
      ...
      <div className="flex items-start">
        <input
          id="terms"
          type="checkbox"
          className="h-4 w-4 mt-1 rounded border-white/20 text-trend-yellow focus:ring-trend-yellow bg-white/10"
          required
        />
        <label htmlFor="terms" className="ml-2 block text-sm text-white/70">
          I agree to the{" "}
          <a href="/terms" className="text-trend-yellow hover:underline">
            Terms and Conditions
          </a>{" "}
          and{" "}
          <a href="/privacy" className="text-trend-yellow hover:underline">
            Privacy Policy
          </a>
        </label>
      </div>
      ...
      <motion.button
        type="submit"
        className="w-full py-2 px-4 rounded-md bg-trend-yellow/90 text-black font-medium hover:bg-trend-yellow transition-colors"
      ...
      <div className="text-center mt-6">
        <p className="text-white/70 text-sm">
          ...
          <button type="button" onClick={onSignInClick} className="text-trend-yellow hover:underline font-medium">
            Sign In
          </button>
        </p>
      </div>
